...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        MediaPlayerInterface advancedMediaPlayerAdapter1 =
                new AdvancedMediaPlayerAdapter(mp4Player);
        advancedMediaPlayerAdapter1.play("mp4", "Alone.mp4");

        AdvancedMediaPlayerInterface vlcPlayer = new Vlc();
        MediaPlayerInterface advancedMediaPlayerAdapter2 =
                new AdvancedMediaPlayerAdapter(vlcPlayer);
